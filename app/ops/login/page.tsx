...
export default function AdminPortalLoginPage() {
  ...
  const [email, setEmail] = useState("admin@hurgelt.local");
  ...
  return (
    <main className="mx-auto flex min-h-[calc(100vh-84px)] max-w-3xl items-center px-6 py-12">
      <div className="glass-panel w-full rounded-[2rem] p-8">
        <div className="eyebrow">Operations Login</div>
        <h1 className="mt-3 text-4xl font-semibold text-[var(--text)]">Админаар нэвтрэх</h1>
        <p className="mt-3 text-sm leading-7 text-[var(--muted)]">
          Хүргэлт, курьер, тайланг удирдах админ эрхээр нэвтэрнэ үү.
        </p>
        ...
        <div className="mt-6 text-sm text-[var(--muted)]">
          Хэрэглэгчийн эрх хэрэгтэй юу?{" "}
          <Link href="/signup" className="font-semibold text-[var(--text)]">
            Бүртгүүлэх
          </Link>
          {" · "}
          <Link href="/track" className="font-semibold text-[var(--accent)]">
            Tracking нээх
          </Link>
        </div>
      </div>
